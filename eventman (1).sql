...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2022 at 08:09 PM
...
(8, '2022-01-01 17:55:44', 'mosiur@gmail.com', 'System', '12345678', 'customers', 'mosiur rahman', '01762762851', 'dhanmondi', 1);
...
(4, '2021-07-13 19:51:46', '2022-09-07', '', 'admin@demo.com', '000006', 'Hello Two Three', 'Natok', 'Tangail Nirala', 'James', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', '1250', 1388, 1200, 704, '01775180188', 'nafis@gmail.com', 1, 1),
...
(19, '2022-01-01 17:56:17', '8', NULL, '000006', 'Hello Two Three', 1, '1250', 1),
(20, '2022-01-01 17:56:38', '8', NULL, '000006', 'Hello Two Three', 1, '1250', 1),
(21, '2022-01-01 17:57:19', '8', NULL, '000006', 'Hello Two Three', 1, '1250', 1),
(22, '2022-01-10 18:02:52', '8', NULL, '000006', 'Hello Two Three', 1, '1250', 1);
...
(8, '2021-10-22 09:35:27', 1, 'Dipu', 'User', 'hi', 1),
(9, '2021-10-22 09:35:57', 1, 'Dipu', 'User', 'how are you?', 1);
...
--
ALTER TABLE `customers`
  MODIFY `xsl` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `orders`
  MODIFY `xsl` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
