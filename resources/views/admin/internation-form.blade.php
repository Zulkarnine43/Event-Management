            ...
            <div class="card card-primary col-md-12">
                <div class="card-header row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8">
                                <h3 class="card-title pull-left">Create Internationl Convocation</h3>
                            </div>
                            <div class="col-md-4 text-right">
                                <a class="btn btn-warning" href="{{ url('internation-list') }}">Internationl Convocation List</a>
                            </div>
                        </div>
                    </div>
                </div>
                
                <form method="post" action='{{ route("create-internation") }}' enctype="multipart/form-data">
                    @csrf
